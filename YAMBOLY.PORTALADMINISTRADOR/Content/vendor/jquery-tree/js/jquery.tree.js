        ...
        return this.each(function() {
            ...
            $(document).on("click", '.' + class_name + ' span.highlight', function() {
                ...
                if ($('.back_btn').length == 0) {
                    $('body').prepend('<img src="Content/vendor/jquery-tree/images/back.png" class="back_btn" />');
                }
                call_structure();
...
//                        data += _addthis.closest('form').serialize();
                        _addthis.closest("li").before("<img src='Content/vendor/jquery-tree/images/load.gif' class='load' />");
...
//                        });
            ...
            if (edit_option) {
                $(document).on("click", '.' + class_name + ' span.edit_action', function() {
                    ...
                    var _this = $(this);
                    var editquery = '<form class="edit_data" method="post" action=""><img class="close" src="Content/vendor/jquery-tree/images/close.png" /><input type="text" class="first_name" name="first_name" value="" placeholder="first name"><input type="checkbox"  value="" name="showhideval" id="hide" /><label for="hide">Hide Child Nodes</label><input type="submit" class="edit" name="submit" value="submit"></form>';
...
//                        data += _editthis.closest('form').serialize();
                        _editthis.closest("li").before("<img src='Content/vendor/jquery-tree/images/load.gif' class='load' />");
                ...
                $(document).on("click", '.' + class_name + ' span.delete_action', function() {
                    ...
                    if ($(this).closest('div').attr('id') == 1) {
                        ...
                        if (confirm_message) {
                            ...
                            $(this).closest("li").before("<img src='Content/vendor/jquery-tree/images/load.gif' class='load' />");
                            $("img.load").remove();
